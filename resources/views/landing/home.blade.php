...
<body class="leading-normal tracking-normal text-gray-900 bg-white" style="font-family: 'Source Sans Pro', sans-serif;">
    <div class="h-screen bg-right bg-cover" style="background-image:url('/assets/home/img/bg.svg');">
        <!--Nav-->
        ...
        <!--Main-->
        <div class="container pt-24 md:pt-48 px-6 mx-auto flex flex-wrap flex-col md:flex-row items-center min-h-screen">
            ...
            <div class="flex flex-col w-full xl:w-2/5 justify-center lg:items-start overflow-y-hidden">
                ...
                <div class="flex w-full justify-center md:justify-start pb-24 lg:pb-0 fade-in">
                    <img src="{{asset('assets/home/img/App Store.svg')}}" class="h-12 pr-4 bounce-top-icons">
                    <img src="{{asset('assets/home/img/Play Store.svg')}}" class="h-12 bounce-top-icons">
                </div>
            ...
            <div class="w-full xl:w-3/5 py-6 overflow-y-hidden">
                <img class="w-5/6 mx-auto lg:mr-0 slide-in-bottom" src="{{asset('assets/home/img/devices.svg')}}">
            </div>
