...
<head>
    ...
    <!-- Style -->
    <link rel="stylesheet" href="../../assets/dashboard/css/style.css" media="all" />
    <link rel="stylesheet" href="../../assets/dashboardAdmin/css/adminSiswa.css" media="all" />
    <!-- BoxIcons -->
...
<body id="dashboard">
            ...
            <div class="dash-content" id="dashContent">
                ...
                <form action="" method="post" class="form-add">
                    <div class="input-data">
                        ...
                        <input type="text" placeholder="Masukkan NIS" required id="nis" name="nis" />
                    </div>
                    <div class="input-data">
                        <label for="nama">Nama</label>
                        <input type="text" placeholder="Masukkan Nama" required id="nama" name="nama"/>
                    </div>
                    <div class="input-data">
                    ...
                    <div class="input-data">
                        ...
                        <input type="text" placeholder="Masukkan Nomor Telepon" required id="notelp" name="notelp"/>
                    </div>
                    <div class="input-data">
                    ...
                    <div class="input-data">
                        ...
                        <input type="date" required id="tanggalLahir" name="tglLahir" />
                    </div>
                    <div class="input-data">
                    ...
                    <div class="input-data">
                        ...
                        <input type="file" required style="display: none" id="inputFile" accept="image/*" />
                    </div>
    ...
    <script src="../../assets/dashboardAdmin/js/main.js" defer></script>
    <script src="../../assets/dashboard/js/main.js" defer></script>
</body>
