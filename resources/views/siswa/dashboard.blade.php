...
<head>
    ...
    <!-- Script -->
    <script src="{{ mix('assets/dashboard/js/main.js') }}"></script>
</head>
<body id="dashboard">
        ...
        <aside class="sidebar" id="sidebar">
            <div class="button-page">
                ...
                <ul class="sidebutton">
                    ...
                    <li class="list-link"><a href="#" class="sidelink"><i class='bx bx-qr'></i>Scan QR</a></li>
                    <li class="list-link"><a href="#" class="sidelink"><i class='bx bxs-trophy' ></i>Leaderboard</a></li>
                    <li class="list-link"><a href="#" class="sidelink"><i class='bx bxs-pie-chart-alt-2'></i>Statistik</a></li>
                </ul>
