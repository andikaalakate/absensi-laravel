  ...
  <aside class="sidebar" id="sidebar">
    <div class="button-page">
      ...
      <ul class="sidebutton">
        ...
        <li class="list-link">
          <a href="/admin/user/" class="sidelink {{ Request::is('admin/user') ? 'active' : '' }}"><i class="bx bxs-user-rectangle"></i>User</a>
        </li>
        <li class="list-link">
          <a href="/admin/peringkat/" class="sidelink {{ Request::is('admin/peringkat') ? 'active' : '' }}"><i class="bx bxs-trophy"></i>Peringkat</a>
        </li>
        <li class="list-link">
